 ...
 */
public class GameUpdateFlow extends FlowLogic<SignedTransaction> {

    private static final ProgressTracker.Step RETRIEVING = new ProgressTracker.Step("Retrieving our old Game State!");
    private static final ProgressTracker.Step SIGNING = new ProgressTracker.Step("Signing the new Game State!");
    private static final ProgressTracker.Step VERIFYING = new ProgressTracker.Step("Verfiying the new Game State!");
    private static final ProgressTracker.Step FINALIZING = new ProgressTracker.Step("Sending the new Game State!") {
        @Nullable
        @Override
    ...
    public GameUpdateFlow(UniqueIdentifier stateLinearId, String winner) {
    ...
    @InitiatedBy(GameUpdateFlow.class)
